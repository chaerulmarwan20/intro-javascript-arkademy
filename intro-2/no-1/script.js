...
// 4. trim()
/**
 * Method String.trim() berfungsi untuk menghapus bagian spasi atau string kosong di awal dan di akhir String.
 */
let alamat = " Sumedang "
 ...
 * Sebuah argumen bisa diinputkan kedalam method ini yang akan berfungsi sebagai pembatas untuk menyatukan array.
 */
let arr = [2, 5, 8, "a", "b", "c"];
...
// 6. reduce()
/**
 * Method ini berfungsi untuk mereduce elemen array menjadi single value dengan menjumlah setiap elemen (dari kiri ke kanan)
 */
...
// 9. find()
/**
 * Method ini berfungsi untuk mencari atau menemukan satu elemen yang sesuai pada array.
